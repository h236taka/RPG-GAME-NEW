                    ...
                    if ( who_is_skillTarget(use_skill_count) == PARTY ){
                      ...
                      if ( skill_target == ENEMY1 ){
                        ...
                        if ( is_enemy_alive(&enemy3) == TRUE ){
                          turn_decrease = player_skill_forEnemy(&st,&player_skill,&enemy3,use_skill_count);
                        }
                        else{
                          skill_target = NOTARGET;
                        }
                  ...
                  if ( (**setting_skill2) -> set_skill[0] != 0 ){
                    ...
                    if ( who_is_skillTarget(use_skill_count) == PARTY ){
                      ...
                      if ( skill_target == ENEMY1 ){
                        ...
                        if ( is_enemy_alive(&enemy3) == TRUE ){
                          turn_decrease = player_skill_forEnemy(&st2,&player_skill2,&enemy3,use_skill_count);
                        }
                        else{
                          skill_target = NOTARGET;
                        }
                  ...
                  if ( (**setting_skill3) -> set_skill[0] != 0 ){
                    ...
                    if ( who_is_skillTarget(use_skill_count) == PARTY ){
                      ...
                      if ( skill_target == ENEMY1 ){
                        ...
                        if ( is_enemy_alive(&enemy3) == TRUE ){
                          turn_decrease = player_skill_forEnemy(&st3,&player_skill3,&enemy3,use_skill_count);
                        }
                        else{
                          skill_target = NOTARGET;
                        }
